...
from nuplan.common.actor_state.state_representation import StateSE2, TimeDuration, TimePoint, StateVector2D
...
from navsim.planning.simulation.observation.navsim_idm_agents import (
    NavsimIDMAgents
)
...
class NavsimIDMTrafficAgents(AbstractTrafficAgentsPolicy):
    ...
    def simulate_traffic_agents(
        ...
        vehicle_current_tracks = filter_tracked_objects_by_type(
            metric_cache.current_tracked_objects,
        ...
        map_api = get_maps_api(
            metric_cache.map_parameters.map_root, metric_cache.map_parameters.map_version, metric_cache.map_parameters.map_name)
        ...
        idm_agents_observation.get_observation(
                ...
                map_api, 
                objects_future_tracks[0].tracked_objects
            )
        ...
        for timestep in range(1,self.future_trajectory_sampling.num_poses+1):
            ...
            future_tracked_objects.append(idm_agents_observation.get_observation(
                ego_state, 
                vehicle_current_tracks, 
                map_api, 
                objects_future_tracks[timestep-1].tracked_objects
